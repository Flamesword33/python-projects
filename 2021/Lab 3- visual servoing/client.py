...
class Client:
    ...
    # Sends a message to the server letting it know that there was an issue during the execution of the movement (obstacle avoided) and 
    # that the initial jacobian should be recomputed (Visual servoing started from scratch)
    def sendReset(self):
